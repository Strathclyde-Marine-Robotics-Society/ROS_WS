...
static const _Photo_type_support_symbol_names_t _Photo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, extra_interfaces, msg, Photo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, extra_interfaces, msg, Photo)),
  }
};
...
{
  return &::extra_interfaces::msg::rosidl_typesupport_cpp::Photo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, extra_interfaces, msg, Photo)() {
  return get_message_type_support_handle<extra_interfaces::msg::Photo>();
}
