...
#include "extra_interfaces/msg/detail/detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const extra_interfaces::msg::Detection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  extra_interfaces::msg::Detection & ros_message)
{
  // Member: box
  {
    cdr >> ros_message.box;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = extra_interfaces::msg::Detection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const extra_interfaces::msg::Detection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<extra_interfaces::msg::Detection *>(
    untyped_ros_message);
...
{
  return &extra_interfaces::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, extra_interfaces, msg, Detection)() {
  return &extra_interfaces::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
