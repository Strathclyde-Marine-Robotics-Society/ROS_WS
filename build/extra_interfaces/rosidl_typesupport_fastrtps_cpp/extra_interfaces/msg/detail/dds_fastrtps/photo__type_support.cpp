...
#include "extra_interfaces/msg/detail/photo__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = extra_interfaces::msg::Photo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const extra_interfaces::msg::Photo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<extra_interfaces::msg::Photo *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Photo__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const extra_interfaces::msg::Photo *>(
...
static size_t _Photo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Photo(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Photo__callbacks = {
...
static rosidl_message_type_support_t _Photo__handle = {
...
{
  return &extra_interfaces::msg::typesupport_fastrtps_cpp::_Photo__handle;
}
